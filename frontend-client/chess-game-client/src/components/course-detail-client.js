...
const API_URL = "http://150.95.113.55:5000/uploads"; // API lưu nội dung tải lên
      ...
      <div className="max-w-4xl mx-auto mt-16">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex flex-col items-center gap-4 md:w-1/3">
            <img
              src={`http://150.95.113.55:5000/uploads/${course?.image1}`}
              alt="Ảnh 1"
              className="w-full object-cover rounded-lg shadow-md"
            />
            <img
              src={`http://150.95.113.55:5000/uploads/${course?.image2}`}
              alt="Ảnh 2"
              className="w-full object-cover rounded-lg shadow-md"
            />
          </div>
                    ...
                    <div className="w-full md:w-2/3">
                      {upload.type.includes("video") ? (
                        <video controls className="w-full h-64 object-cover rounded-lg">
                          <source src={`http://150.95.113.55:5000/uploads/${upload.file}`} type="video/mp4" />
                        </video>
                      ) : (
                        <img
                          src={`http://150.95.113.55:5000/uploads/${upload.file}`}
                          alt="Upload"
